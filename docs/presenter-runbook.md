...
4. **Chair — 75 seconds.** Log in as chair. Show the recommended next action, reconciled counts, conference memory, and explicit acceptance waves. State the history coverage: 13 event series, 199 editions, 18,432 talks, 20,238 speaker credits, and 13,375 speakers, with source gaps recorded explicitly. Say: “Only the chair applies acceptance or rejection; the audit records who and when. AIE's programming memory survives staff turnover without automating taste.”
...
- Conference memory reports the full known backfill with 13 catalogs, 199 editions, 18,432 talks, 20,238 speaker credits, 13,375 speakers, and explicit source-gap records rather than invented sessions.
