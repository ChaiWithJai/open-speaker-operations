...
4. **Chair — 75 seconds.** Log in as chair. Show the recommended next action, reconciled counts, conference memory, and explicit acceptance waves. State the history coverage: 13 event series, 204 editions, 19,466 talks, 21,419 speaker credits, 21,355 edition-scoped source identities, and 14,068 provisional person clusters, with source gaps recorded explicitly. Say: “Only the chair applies acceptance or rejection; the audit records who and when. AIE's programming memory survives staff turnover without automating taste.”
...
- Conference memory reports the full known backfill with 13 catalogs, 204 editions, 19,466 talks, 21,419 speaker credits, 21,355 source identities, 14,068 provisional person clusters, and explicit source-gap records rather than invented sessions.
