...
RESOURCES = (
    ...
    ResourceLink(
        "abstract-console",
        "abstract-management",
        "speakerops_abstract_management",
        ("event",),
        "organiser",
        AGGREGATE,
    ),
    ResourceLink(
        ...
        "abstract-management",
        "speakerops_submission_presenters",
        ("event", "code"),
        "organiser",
        DETAIL,
    ),
