...
RESOURCES = (
    ...
    ResourceLink(
        ...
        "used by the legacy dashboard form.",
    ),
    ResourceLink(
        resource="speaker-nudge-preview",
        judged_row="automated-communication",
        route_name="speakerops_speaker_nudge_preview",
        url_kwargs=("event", "correlation", "nonce"),
        audience="organiser",
        object_kind="reminder-action-preview",
        exactness=FILTERED_COLLECTION,
        note="GET-safe correlated preview; the page posts to a separate confirmed command.",
    ),
    ResourceLink(
        resource="speaker-nudge-confirm",
        judged_row="automated-communication",
        route_name="speakerops_speaker_nudge_confirm",
        url_kwargs=("event", "correlation", "nonce"),
        audience="organiser",
        object_kind="reminder-action",
        exactness=FILTERED_COLLECTION,
        interaction=COMMAND,
        note="POST-only human-confirmed reminder action with a durable workflow receipt.",
    ),
    ResourceLink(
    ...
    ResourceLink(
        resource="sync-retry-preview",
        judged_row="integrations-csv",
        route_name="speakerops_sync_recovery_preview",
        url_kwargs=("event", "correlation", "nonce"),
        audience="organiser",
        object_kind="failed-sync-item-preview",
        exactness=FILTERED_COLLECTION,
        note="GET-safe preview containing only currently failed SyncItem records.",
    ),
    ResourceLink(
        resource="sync-selective-retry",
        judged_row="integrations-csv",
        route_name="speakerops_sync_recovery_confirm",
        url_kwargs=("event", "correlation", "nonce"),
        audience="organiser",
        object_kind="failed-sync-item-retry",
        exactness=FILTERED_COLLECTION,
        interaction=COMMAND,
        note="POST-only selective retry, revalidated at confirmation time and receipted.",
    ),
    ResourceLink(
    ...
    ResourceLink(
        resource="workflow-action-receipts",
        judged_row="integrations-csv",
        route_name="speakerops_workflow_action_receipts",
        url_kwargs=("event",),
        audience="organiser",
        object_kind="workflow-action-receipt-list",
        exactness=FILTERED_COLLECTION,
    ),
    ResourceLink(
        resource="workflow-action-receipt",
        judged_row="integrations-csv",
        route_name="speakerops_workflow_action_receipt",
        url_kwargs=("event", "pk"),
        audience="organiser",
        object_kind="workflow-action-receipt",
        exactness=EXACT_RECORD,
    ),
    ResourceLink(
